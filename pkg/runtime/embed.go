...
//
// This file is compiled only with the `standalone` build tag; it uses
...
// ExtractPath writes the standalone runtime to a stable location (once) and
...
// Exec extracts the standalone runtime and execs it with args, replacing the
