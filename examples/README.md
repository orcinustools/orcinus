...
| [`kubevirt/`](./kubevirt/vm-compose.yml) | **Virtual machines next to containers** (KubeVirt). Compose style via `x-orcinus-vm`: [`vm-compose.yml`](./kubevirt/vm-compose.yml) and [`vm-compose-web.yml`](./kubevirt/vm-compose-web.yml) (persistent disk + SSH key + ingress). Raw-manifest style: [`orcinus.yml`](./kubevirt/orcinus.yml) — a container + Ubuntu/Fedora VMs reachable by Service DNS. Plus [`distros.yml`](./kubevirt/distros.yml) (a stopped Ubuntu/Fedora/Debian/CentOS/Alma/openSUSE catalog), [`cdi-datavolume.yml`](./kubevirt/cdi-datavolume.yml) (persistent disk via CDI) and [`ssh-public.yml`](./kubevirt/ssh-public.yml) (**SSH by key + public IP/ingress**). See [`../docs/PLUGINS.md`](../docs/PLUGINS.md#virtual-machines-kubevirt). |
